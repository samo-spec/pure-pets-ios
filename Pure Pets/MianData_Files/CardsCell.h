...
@protocol JPCardCellDelegate<NSObject>

@optional
- (void)cardCellPlayButtonDidClick:(CardsCell *)cell;
@end
...
@interface CardsCell : UICollectionViewCell
...
@property (weak, nonatomic) NSString *VidThum;
@property (weak, nonatomic) IBOutlet UIImageView *videoPlayView;
@property(nonatomic, weak) id<JPCardCellDelegate> playDelegate;
...
@property  (weak, nonatomic) ArchiveModel *archiveClass;
...
@property (weak, nonatomic) IBOutlet PressButton *saleBirdBTN;
