...
- (void)sidebar:(RNFrostedSidebar *)sidebar didTapItemAtIndex:(NSUInteger)index WithSubKind:(SubKindModel *)subKind;
//- (void)sidebar:(RNFrostedSidebar *)sidebar didTapItemAtIndex:(NSUInteger)index WithMainKind:(MainKindsModel *)mainKind;
@end
