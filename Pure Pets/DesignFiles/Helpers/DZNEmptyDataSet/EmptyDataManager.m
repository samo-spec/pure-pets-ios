...
- (NSAttributedString *)titleForEmptyDataSet:(UIScrollView *)scrollView
{
    ...
    NSString *textData = @"عفوا لاتوجد بيانات";
    NSString *textDataEmptyDataTypeCart = @"";
    ...
    {
        textData = @"عفوا لاتوجد بيانات";
        textDataEmptyDataTypeCart = @"عرض الكل";
    }
    else
        {
            textData = @"Sorry No data found";
            textDataEmptyDataTypeCart = @"view all";
        }
