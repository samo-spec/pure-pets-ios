...
@interface PPGlassButton : UIButton

/// Factory
+ (instancetype)glassButton;

/// Configure content
- (void)setSystemImage:(NSString *)systemName
...
@property (nonatomic, strong, readonly, nonnull) PPGlassButton *HUDView;
/*
 _blurViewContainer = [PPNavigationController setButtonAsBackroundButtonWithStyle:UIButtonConfigurationCornerStyleLarge configType:PPButtonConfigrationGlass];
