...
- (instancetype)initWithStyle:(JGProgressHUDStyle)style {
    ...
    if (self) {
        ...
        _automaticStyle = NO;
        _HUDView = [PPGlassButton glassButton];
...
- (UIVisualEffectView *)blurView {
    if (!_blurView) {
        ...
        _blurView = [[UIVisualEffectView alloc] init];//WithEffect:blurEffect
...
@implementation PPGlassButton

+ (instancetype)glassButton {

    PPGlassButton *btn = [PPGlassButton buttonWithType:UIButtonTypeSystem];
    ...
    if (@available(iOS 26.0, *)) {
        ...
        cfg.baseForegroundColor = UIColor.clearColor;
...
- (void)setSystemImage:(NSString *)systemName title:(NSString *)title {
