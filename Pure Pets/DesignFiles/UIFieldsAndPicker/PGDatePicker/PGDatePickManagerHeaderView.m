...
- (void)setupButton {
    self.cancelButton.titleLabel.font = [GM MidFontWithSize:16];
    ...
    self.cancelButton.backgroundColor = [UIColor colorWithHexString:@"#EBEBEB"];
    
    self.confirmButton.titleLabel.font = [GM MidFontWithSize:16];
    ...
    self.confirmButton.backgroundColor = [UIColor colorWithHexString:@"#EBEBEB"];
    self.confirmButton.layer.cornerRadius = 10;
    self.cancelButton.layer.cornerRadius = 10;
    self.confirmButton.layer.maskedCorners = kCALayerMaxXMaxYCorner;
    self.cancelButton.layer.maskedCorners = kCALayerMinXMaxYCorner;
}
