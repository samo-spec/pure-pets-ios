...
-(void) initVariables
{
    ...
    _digitFont = [UIFont systemFontOfSize:22.0f];
...
-(void) setupInit
{
    ...
    if(!self.showUnderlineInsteadOfBorder)[self setView:textField cornerWithRadius:8.0f borderWidth:2.0f borderColor:self.focusBorderColor];
