...
{
    return _emptyTitleFont ?: [GM boldFontWithSize :18.0f];
}

- (UIFont *)emptySubtitleFont
{
    return _emptySubtitleFont ?: [GM MidFontWithSize :15.0f];
}

- (UIFont *)emptyBtntitleFont
{
    return _emptyBtntitleFont ?: [GM MidFontWithSize :16.0f];
}

- (UIColor *)emptyTitleColor
{
    return _emptyTitleColor ?:  GM.appPrimaryColor;
}
