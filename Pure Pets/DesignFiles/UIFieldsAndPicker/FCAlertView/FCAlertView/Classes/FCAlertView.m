...
- (void)pp_addModernBlurToView:(UIView *)targetView {
...
- (id)init
{
    ...
    if (self) {
        ...
        _alertBackground.frame = CGRectMake(0,
                                            ...
                                            result.width,
                                            result.height);
        _alertBackground.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.2];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (_subtitleFont != nil)
        ...
        descriptionLabel.font = [GM MidFontWithSize:16.0f];
    else
        descriptionLabel.font = [GM MidFontWithSize:16.0f];
