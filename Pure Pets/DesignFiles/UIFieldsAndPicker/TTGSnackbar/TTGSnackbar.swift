...
extension UIColor {
  ...
  @objc class open dynamic var ttgDefaultBackground : UIColor {
    if #available(iOS 13, *) {
      ...
      return UIColor.init(white: 0, alpha: 0.9)
    }
  }
...
open class TTGSnackbar: UIView {
    ...
    @objc public static var snackbarDefaultFrame: CGRect = CGRect(x: 0, y: 16, width: 320, height: 50)
    
    /// Snackbar min height
    @objc public static var snackbarMinHeight: CGFloat = 50
    ...
    @objc open dynamic var animationType: TTGSnackbarAnimationType = TTGSnackbarAnimationType.slideFromTopBackToTop;
    ...
    @objc open dynamic var cornerRadius: CGFloat = 25 {
        didSet {
    ...
    @objc open dynamic var topMargin: CGFloat = 10 {
        didSet {
    ...
    @objc open dynamic var leftMargin: CGFloat = 10 {
        didSet {
    ...
    @objc open dynamic var rightMargin: CGFloat = 10 {
        didSet {
    ...
    @objc open dynamic var contentInset: UIEdgeInsets = UIEdgeInsets.init(top: 7, left: 12, bottom: 7, right: 12) {
        didSet {
    ...
    @objc open dynamic var messageContentInset: UIEdgeInsets = UIEdgeInsets.init(top: 2, left: 10, bottom: 2, right: 10) {
        didSet {
    ...
    /// All action button max width, min = 44 //actionMaxWidth //actionTextNumberOfLines // iconImageView
...
open class TTGSnackbarManager : NSObject {
    @MainActor @objc public static let shared = TTGSnackbarManager()
