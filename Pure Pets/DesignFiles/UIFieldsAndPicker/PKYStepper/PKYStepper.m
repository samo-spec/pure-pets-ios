...
- (void)commonInit
{
    ...
    self.countLabel.layer.borderWidth = 0.0f;
    ...
    [self setLabelTextColor:[GM appPrimaryColor]];
    [self setButtonTextColor:UIColor.lightGrayColor forState:UIControlStateNormal];
    
    [self setLabelFont:[GM MidFontWithSize:16]];
    [self setButtonFont:[GM MidFontWithSize:40]];
}
...
{
    self.countLabel.textColor = [GM appPrimaryColor];
}
...
{
    [self.incrementButton setTitleColor:UIColor.lightGrayColor forState:state];
    [self.decrementButton setTitleColor:UIColor.lightGrayColor forState:state];
}
