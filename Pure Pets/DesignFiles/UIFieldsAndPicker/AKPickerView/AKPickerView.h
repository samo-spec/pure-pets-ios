...
- (UIButton *)pickerView:(AKPickerView *)pickerView buttonForItem:(NSInteger)item;
...
- (void)pickerView:(AKPickerView *)pickerView configureButton:(UIButton * const)btn forItem:(NSInteger)item;
- (void)pickerView:(AKPickerView *)pickerView configureView:(UIView * const)btn forItem:(NSInteger)item;
@end
