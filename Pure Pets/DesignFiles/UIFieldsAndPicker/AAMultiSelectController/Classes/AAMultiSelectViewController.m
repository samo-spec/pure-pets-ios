...
static CGFloat const viewCornerRadius                  = 25.f;
static CGFloat const tableViewRowHeight                = 40;
...
static CGFloat const buttonCornerRadius                = 15.f;
static CGFloat const buttonTitleFontSize               = 12.0;
static CGFloat const buttonInsetsTop                   = 10.0;
static CGFloat const buttonInsetsLeft                  = 20.0;
static CGFloat const buttonInsetsBottom                = 10.0;
static CGFloat const buttonInsetsRight                 = 20.0;
...
- (void)setupTitleLabel {
    ...
    titleLabel.frame = CGRectMake(0, 0, CGRectGetWidth(weakself.view.frame), 44);
    [self.view addSubview:titleLabel];
   
    //self.titleLabel.frame = CGRectMake(0, 0, CGRectGetWidth(self.view.frame), 44);
...
- (void)setupButtons {
    ...
    [self.confirmButton setTitle:@"اختيار" forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    cell.titleTextColor             = [UIColor blackColor];
    cell.titleFont                  = [UIFont systemFontOfSize:12];
