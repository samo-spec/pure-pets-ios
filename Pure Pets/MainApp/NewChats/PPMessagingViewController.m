//
//  PPMessagingViewController 2.h
//  Pure Pets
//
//  Created by Mohammed Ahmed on 28/07/2025.
//

// PPMessagingViewController.m
// Pure Pets
...
#import "PPMessagingViewController+helper.h"
...
@interface PPMessagingViewController () <UITableViewDelegate, UITableViewDataSource,
                                     UITextFieldDelegate,
...
@property (nonatomic, assign) BOOL didCaptureNavigationBarVisibility;
...
- (void)viewDidLoad {
    ...
    [self pp_installSwiftUIPresentation];
}
