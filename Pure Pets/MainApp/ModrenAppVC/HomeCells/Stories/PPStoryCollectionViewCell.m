...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // Verified badge on avatar corner (18pt for 64pt avatar)
        _verifiedBadgeView = [PPVerifiedBadgeHelper addBadgeToAvatarView:_imageView
              ...
              showAddBadge:(BOOL)showAddBadge
{
    ...
    self.verifiedBadgeView.hidden = !(storyUser.isVerified);
