...
- (void)pp_setupBlockedOverlayIfNeeded {
    ...
    topGlowView.layer.shadowColor = primaryColor.CGColor;
    ...
    bottomGlowView.layer.shadowColor = primaryGlowColor.CGColor;
    ...
    brandPillView.layer.borderColor = [[whiteTint colorWithAlphaComponent:0.12] CGColor];
    brandPillView.layer.shadowColor = UIColor.blackColor.CGColor;
    ...
    animationPlateView.layer.borderColor = [[whiteTint colorWithAlphaComponent:0.14] CGColor];
    animationPlateView.layer.shadowColor = UIColor.blackColor.CGColor;
    ...
    animationGlowView.layer.shadowColor = primaryGlowColor.CGColor;
...
- (UIButton *)pp_makeBlockedOverlayButtonWithTitle:(NSString *)title
    ...
    if (emphasized) {
        ...
        button.layer.borderColor =
            [[foregroundColor colorWithAlphaComponent:destructive ? 0.22 : 0.12] CGColor];
