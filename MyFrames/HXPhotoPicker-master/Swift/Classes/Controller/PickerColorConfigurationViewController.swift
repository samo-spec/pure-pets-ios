...
extension PickerColorConfigurationViewController {
    ...
    enum PickerColorConfigRow: String, CaseIterable, ConfigRowTypeRule {
        ...
        var title: String {
            switch self {
            case .navigationViewBackgroundColor:
                return "Navigation controller background color"
            case .navigationViewBackgroudDarkColor:
                return "Background color of navigation controller in dark style"
            case .navigationTitleColor:
                return "Navigation bar title color"
            case .navigationTitleDarkColor:
                return "Navigation bar title color in dark style"
            case .navigationTintColor:
                return "TintColor"
            case .navigationDarkTintColor:
                return "TintColor in dark style"
            }
        }
    ...
    enum AlbumListColorConfigRow: String, CaseIterable, ConfigRowTypeRule {
        ...
        var title: String {
            switch self {
            case .limitedStatusPromptColor:
                return "Prompt color under accessible permissions"
            case .limitedStatusPromptDarkColor:
                return "The color of the prompt under dark style access permissions"
            case .backgroundColor:
                return "List background color"
            case .backgroundDarkColor:
                return "dark style list background color"
            case .cellBackgroundColor:
                return "cell background color"
            case .cellbackgroundDarkColor:
                return "cell background color in dark style"
            case .cellSelectedColor:
                return "The color of the cell when it is selected"
            case .cellSelectedDarkColor:
                return "The color of the selected cell in dark style"
            case .albumNameColor:
                return "Album name color"
            case .albumNameDarkColor:
                return "Album name color in dark style"
            case .photoCountColor:
                return "Photo quantity color"
            case .photoCountDarkColor:
                return "Album name color in dark style"
            case .separatorLineColor:
                return "divider color"
            case .separatorLineDarkColor:
                return "Separator color in dark style"
            case .tickColor:
                return "The color of the selected tick"
            case .tickDarkColor:
                return "The color of the selected tick in dark style"
            }
        }
    ...
    enum PhotoListColorConfigRow: String, CaseIterable, ConfigRowTypeRule {
        ...
        var title: String {
            ...
            case .backgroundDarkColor:
                return "Background color in dark style"
            case .titleViewBackgroundColor:
                return "title" + "background color"
            case .titleViewBackgroundDarkColor:
                return "Title" + "Background color in dark style"
            case .titleViewArrowBackgroundColor:
                return "title" + "arrow background color"
            case .titleViewArrowBackgroudDarkColor:
                return "title" + "arrow background color in dark style"
            case .titleViewArrowColor:
                return "title" + "arrow color"
            case .titleViewArrowDarkColor:
                return "Title" + "Dark style down arrow color"
            case .cellTitleColor:
                return "Cell" + "Color of number after selection"
            case .cellTitleDarkColor:
                return "Cell" + "The color of the number after selection in dark style"
            case .cellTickColor:
                return "Cell" + "Tick color after selection"
            case .cellTickDarkColor:
                return "Cell" + "Tick color after selection in dark style"
            case .cellSelectedBackgroundColor:
                return "Cell" + "Background color after selection box is selected"
            case .cellSelectedBackgroudDarkColor:
                return "Cell" + "Background color of the selected box in dark style"
            }
        }
    ...
    enum PreviewViewColorConfigRow: String, CaseIterable, ConfigRowTypeRule {
        ...
        var title: String {
            ...
            case .backgroundDarkColor:
                return "Background color in dark style"
            case .selectTitleColor:
                return "select box text color"
            case .selectTitleDarkColor:
                return "Select box text color in dark style"
            case .selectTickColor:
                return "Select box check color"
            case .selectTickDarkColor:
                return "check color of selection box in dark style"
            case .selectedBackgroundColor:
                return "Background color after selection box is selected"
            case .selectedBackgroudDarkColor:
                return "Background color of the selected box in dark style"
            }
        }
