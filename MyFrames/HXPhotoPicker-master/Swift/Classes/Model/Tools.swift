...
// let lyricUrl1 = Bundle.main.url(forResource: "Heavenly Foreign Thing", withExtension: nil)!
...
//        musics.append(music1)
        ...
        let lyricUrl7 = Bundle.main.url(forResource: "The beauty of the world is linked to you", withExtension: nil)!
        let lrc7 = try! String(contentsOfFile: lyricUrl7.path) // swiftlint:disable:this force_try
        let music7 = VideoEditorMusicInfo.init(audioURL: .bundle(resource: "The beauty of the world is linked to you", type: "mp3"),
                                               lrc: lrc7)
