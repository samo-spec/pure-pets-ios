Pod::Spec.new do |spec|
    ...
    spec.version            = "5.0.5"
    spec.summary = "Photo/video picker - support for LivePhoto, GIF image selection, custom editing of photos/videos, 3DTouch preview, browse the web image function"
