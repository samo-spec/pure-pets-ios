...
public struct PhotoTools {
    ...
    /// Convert the video duration to a string in mm:ss format
    ...
    /// Get the video duration based on the video address
...
//        let second = TimeInterval(urlAsset.duration.value) / TimeInterval(urlAsset.duration.timescale)
    ...
    /// Get seconds based on video duration (00:00:00)
    ...
    /// Get the video cover based on the video address
