...
public extension PhotoTools {
    ...
    /// Get the image cache folder path
    ...
    /// Get the video cache folder path
    ...
    /// Delete the audio temporary cache
    @discardableResult
    ...
    /// Get the video cache file address
    /// - Parameter key: key to generate the file
    @discardableResult
    ...
    /// - Parameter key: the key corresponding to the video
    @discardableResult
    ...
    /// Get the temporary path of the corresponding suffix
    @discardableResult
