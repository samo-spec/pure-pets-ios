...
checks.append(("context persists while trust utilities reveal additively", "if let context = model.context" in ready_source and "if showsIdentityExpansion" in ready_source and "deckIdentity" not in ready_source and "SpearHeaderDeck" in context_view_source and "SpearHeaderDeck" in expansion_source and "struct SpearHeaderDeck" in deck_source))
checks.append(("accessibility expansion is bounded and scrollable", "ScrollView(.vertical)" in expansion_source and "accessibilityExpansionMaximumHeight" in expansion_source and "accessibilityExpansionMaximumHeight" in style_source))
